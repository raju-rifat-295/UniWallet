...
<head>
    ...
    <link rel="icon" type="image/png" href="/uniwallet/assets/images/logo.jpeg">
...
<body class="bg-light">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary mb-4 shadow-sm">
        <div class="container">
            <a class="navbar-brand fw-bold d-flex align-items-center" href="/uniwallet/index.php">
                <img src="/uniwallet/assets/images/logo.jpeg" alt="UniWallet Logo" width="32" height="32" class="d-inline-block align-text-top me-2 rounded">
                UniWallet
            </a>
